table.Merge( _LAMBDAPLAYERSWEAPONS, {
    ...
    fn_pistolsup = {
        model = "models/fortnite/w_fbr_specopspistol.mdl", 
        origin = "Fortnite",
        prettyname = "Suppressed Pistol",
        holdtype = "revolver",
        ismelee = false,
        ...
        killicon = "vgui/fortnite/pistolsup",
        bulletcount = 1,
        tracername = "Tracer",
        attacksnd = "fortnite/pistol_specops_shoot_*3*.ogg",
        clip = 16,
        spread = 0.1,
        bonemerge = true, 
