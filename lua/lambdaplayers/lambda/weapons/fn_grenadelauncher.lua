...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    ...
    fn_grenadelauncher = {
        model = "models/fortnite/w_fbr_gl180.mdl",
        origin = "Fortnite",
       ...
       OnDeploy = function(self, wepent)
           self:EmitSound("fortnite/gl_deploy.ogg", 90)
           end,
