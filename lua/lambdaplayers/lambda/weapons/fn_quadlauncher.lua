...
local trTbl = { filter = {} }
local laserMat = Material( "vgui/fortnite/colloseye" )
local reloadTime = 0.04
...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    fn_quadlauncher = {
        model = "models/fortnite/w_fbr_m202.mdl",
        origin = "Fortnite",
        prettyname = "Quad Launcher",
        holdtype = "rpg",
        ...
        OnAttack = function( self, wepent, target )
            ...
            self:EmitSound("fortnite/m202_fire_1.ogg", 90)
            self.l_WeaponUseCooldown = ( CurTime() + LambdaRNG( reloadTime, 2.5, true ) )
