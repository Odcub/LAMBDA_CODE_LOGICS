...
-- FIX: Initialize this table here to prevent the 'attempt to index global' error.
-- This ensures the table exists on the client before it is accessed on line 64.
