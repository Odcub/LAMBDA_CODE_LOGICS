...
hook.Add( "LambdaOnModulesLoaded", "lambdaplayers_mwspersonalities", function()
    -- FIX: Check if the table exists before trying to use it
    if not LambdaPersonalityConVars then 
        print( "Lambda MWS Warning: LambdaPersonalityConVars is missing. Skipping personality sliders." )
        return 
    end
