...
CreateLambdaConvar( "lambdaplayers_lambda_adaptivethink", 1, true, false, false, "If enabled, multiplayer servers will use adaptive/staggered NextThink intervals to reduce CPU spikes (recommended)", 0, 1, { type = "Bool", name = "Adaptive Think (Multiplayer)", category = "Lambda Server Settings" } )
